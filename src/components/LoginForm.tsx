...
const LoginForm: React.FC<{
  ...
  return (
    <>
      <div className="flex w-full gap-5 min-h-screen p-4">
        <div className="hidden lg:flex items-center justify-center flex-1 text-black rounded-lg">
              ...
              <>
                ...
                >
                  ...
                  <div className="flex gap-x-5 w-full">
                    <h3 className="font-bold">Redirigiendo</h3>
